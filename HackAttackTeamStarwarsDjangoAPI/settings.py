"""
Django settings for HackAttackTeamStarwarsDjangoAPI project.
...
ROOT_URLCONF = 'HackAttackTeamStarwarsDjangoAPI.urls'
...
WSGI_APPLICATION = 'HackAttackTeamStarwarsDjangoAPI.wsgi.application'
